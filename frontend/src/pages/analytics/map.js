  ...
  return (
    <Fragment>
      <div className="container h-[100%]">
        <h1 className="text-center font-medium mb-[10px] text-[#2f5e9b]">Sales History from location Perspective</h1>
            ...
            >
              {markers.map(({ id, name, position, high_sold, date }) => (
                <MarkerF
                  ...
                  icon={{
                    url: activeMarker === id ? "https://maps.google.com/mapfiles/kml/paddle/grn-circle.png" : "https://maps.google.com/mapfiles/kml/paddle/red-circle.png",
                ...
                >
                  {activeMarker === id ? (
                    <InfoWindowF onCloseClick={() => setActiveMarker(null)}>
                      <div>
                      <p className=" text-[#2f5e9b] text-[15px] font-bold mb-[10px]">{name}</p>
                      <p className="mb-[5px] font-medium">Date: {date}</p>
                       
                        <p className="mb-[5px] font-medium">Highly Sold: {high_sold.join(", ")}</p>
